...
public class PaymentBkash extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon("pics/BkashPay.png");
	...
	public PaymentBkash() {
		...
		l1.setBounds(350, 220, 200, 45);  // Adjusted Y position
		l1.setForeground(Color.black);
		l1.setFont(new Font("Times New Roman", Font.BOLD, 20));
		p1.add(l1);

		l2 = new JLabel("PIN Code : ");
		l2.setBounds(350, 320, 200, 45);  // Adjusted Y position
		l2.setForeground(Color.black);
		l2.setFont(new Font("Times New Roman", Font.BOLD, 20));
		p1.add(l2);

		phone = new JTextField();
		phone.setBounds(350, 260, 230, 30);  // Adjusted Y position
		phone.setFont(font);
		phone.setBackground(new Color(255, 255, 255, 250));
		p1.add(phone);

		pin = new JPasswordField();
		pin.setBounds(350, 360, 230, 30);  // Adjusted Y position
		pin.setFont(font);
