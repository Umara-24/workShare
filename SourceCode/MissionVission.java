...
public class MissionVission extends JFrame implements ActionListener {
	...
	ImageIcon icon = new ImageIcon ("pics/Vision Mission.png");


	public MissionVission()
	{
		super("Vission & Mission");
